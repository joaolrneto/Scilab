//Programa visualiza os 10 maiores casos da Covid-19 no mundo
//A base de dados utilizada é siponibilizada no endereço
// https://github.com/CSSEGISandData/COVID-19 da Johns Hopkins
//O código original do programa está disponível no sitio
//do Scilab https://www.scilab.org/tutorials
clc
clear
close()
exec importdata.sci;
